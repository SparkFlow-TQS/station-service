...
class BookingControllerIT {
        ...
        void setUp() {
                ...
                when(restTemplate.getForObject("http://dummy-user-service-url/users/999",
                                Object.class)).thenThrow(new RuntimeException("User not found"));
                ...
                MvcResult result = mockMvc
                                .perform(post("/api/v1/bookings")
                                                ...
                                                .content(objectMapper
                                                                .writeValueAsString(inputBooking)))
                                .andExpect(status().isCreated()).andReturn();

                Booking createdBooking = objectMapper.readValue(
                                result.getResponse().getContentAsString(), Booking.class);
        ...
        void whenGetAllBookings_thenReturnList() throws Exception {
                mockMvc.perform(get("/api/v1/bookings").param("userId", "1"))
                                ...
                                .andExpect(jsonPath("$[0].stationId")
                                                .value(testBooking.getStationId()));
        }
