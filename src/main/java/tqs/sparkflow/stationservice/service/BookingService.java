...
public interface BookingService {
  /**
   * Creates a recurring booking for a user at a station. Validates that the user exists and has
   * permission to make bookings.
   *
  ...
  /**
   * Creates a new booking. Validates that the user exists and has permission to make bookings.
   *
  ...
  /**
   * Gets a booking by its ID. Validates that the requesting user has permission to view the
   * booking.
   *
  ...
  /**
   * Gets all bookings. Only returns bookings that the user has permission to view.
   *
  ...
  /**
   * Cancels a booking. Validates that the user has permission to cancel the booking.
   *
   * @param id The booking ID
  ...
  /**
   * Gets all bookings for a specific station. Only returns bookings that the user has permission to
   * view.
   *
  ...
  /**
   * Gets all bookings for a specific user. Validates that the requesting user has permission to
   * view the bookings.
   *
