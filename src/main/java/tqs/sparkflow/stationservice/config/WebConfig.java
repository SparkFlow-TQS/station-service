...
/**
 * Web configuration that adds the /api/v1 prefix to controllers except RootController and
 * SpringDoc. This centralizes the API versioning and makes it easier to maintain.
 */
@Configuration
