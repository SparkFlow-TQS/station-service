...
public class StatisticsController {
  ...
  public ResponseEntity<List<StatisticsDTO.CostTrendData>> getCostTrendData(
      @Parameter(description = "User ID", required = true) @RequestParam Long userId,
      @Parameter(description = "Number of months for trend analysis", example = "8") 
  ...
  public ResponseEntity<StatisticsDTO.PeriodDetails> getPeriodDetails(
      @Parameter(description = "User ID", required = true) @RequestParam Long userId,
      @Parameter(description = "Period type (month or week)", example = "month") @RequestParam String type,
      @Parameter(description = "Period value (e.g., '2024-01' for month, '1' for week)", example = "2024-01") 
